$(function(){
	...
	$pintuercheck=function(element,type,value){
		...
		switch(type){
			...
			case "pwd" :return /^.{1,10}$/.test($pintu);break;
			case "name" :return /^.{1,20}$/.test($pintu);break;
			case "idcard" :return /^\d{17}(\d|x|X)$/.test($pintu);break;
			case "corporation" :return /^.{1,20}$/.test($pintu);break;
