      ...
      <tr>
    	...
    	<%		ArrayList<Goods> jijian = (ArrayList<Goods>)request.getAttribute("jijian");
				...
				<tr>
					...
					<td><input type="button" onclick="javascrtpt:window.location.href='/ExpressLogisticsInformationSystem/GoodsServlet?m=GupdateForTransportForCustomer&goodsId=<%=good.getGoodsid() %>&status=5&s=<%=good.getStatus() %>'" value="截胡"/></td>
				</tr>
				  <%}
			} %>  
      <tr>
