...
<div class="panel admin-panel margin-top">
    ...
    <div class="body-content">
        <form method="post" class="form-x" action="/ExpressLogisticsInformationSystem/CompanyServlet?m=update">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input" name="phone" value="<%=company.getPhone() %>"/>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
                ...
                <div class="field">
                    <input type="text" class="input" name="corporation" value="<%=company.getCorporation() %>"/>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
                ...
                <div class="field">
                    <input type="text" class="input" name="pwd" value="<%=company.getPwd() %>"/>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
                ...
                <div class="field">
                    <input type="text" readonly="readonly" class="input" name="time"
                           value="<%=company.getRegtime()  %>"/>
                </div>
            </div>
